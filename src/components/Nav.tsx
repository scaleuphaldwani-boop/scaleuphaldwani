...
export function Nav() {
  ...
  return (
    <motion.header
      ...
      className="fixed inset-x-0 top-0 z-50 border-b border-border/60 bg-background/95 md:bg-background/85 md:backdrop-blur-md"
    >
      ...
      <AnimatePresence initial={false}>
        {open && (
          <motion.div
            ...
            className="overflow-hidden border-t border-border/60 bg-background/98 md:hidden"
          >
